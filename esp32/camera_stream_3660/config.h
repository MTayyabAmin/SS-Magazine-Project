...
#define STATIC_IP_ADDR     192, 168, 137, 10   // Robot 1 Camera (Fixed)
#define GATEWAY_IP_ADDR    192, 168, 137, 1    // Laptop 2.4GHz Hotspot Gateway
#define SUBNET_MASK        255, 255, 255, 0
#define DNS_IP_ADDR        192, 168, 137, 1

// mDNS hostname -> Browser ya Python mein: http://robot1-cam.local:81/stream
#define MDNS_HOSTNAME      "robot1-cam"
...
#define CAM_JPEG_QUALITY 16  // 0-63, lower = better quality (pehle 12 tha)
